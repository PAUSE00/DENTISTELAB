...
import { Zap, CheckCircle2, Users, Activity } from 'lucide-react';
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', padding: 48 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <img 
               src="/images/logo.png" 
               alt="Logo" 
               style={{ width: 44, height: 44, objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(96,221,198,0.4))' }} 
            />
            <span style={{ fontSize: 22, fontWeight: 800, letterSpacing: '-0.3px' }}>
              Dental<span style={{ color: '#60ddc6' }}>Lab</span>Pro
            </span>
          </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 40 }}>
            <img src="/images/logo.png" alt="Logo" style={{ width: 38, height: 38, objectFit: 'contain' }} />
            <span style={{ fontSize: 19, fontWeight: 800 }}>Dental<span style={{ color: '#60ddc6' }}>Lab</span>Pro</span>
          </div>
