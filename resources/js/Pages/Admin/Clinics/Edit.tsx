...
import { ArrowLeft, Save, Building2, MapPin, Phone, User, X } from 'lucide-react';
...
export default function Edit({ clinic, current_owner_id, dentists }: Props) {
    ...
    return (
        <AdminLayout header={t('Edit Clinic')}>
            <Head title={`${t('Edit')} ${clinic.name}`} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h2 className="text-xl font-bold tracking-tight" style={{ color: 'var(--txt-1)' }}>
                            {t('Edit')} <span style={{ color: 'var(--accent)' }}>{clinic.name}</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="rounded-2xl p-5 border" style={{ background: 'var(--bg-raised)', borderColor: 'var(--border)' }}>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
                                    <div className="w-2 h-2 rounded-full shadow-[0_0_8px_rgba(56,189,248,0.6)] bg-[#38bdf8]" />
                                    <span className="text-[11px] font-bold uppercase tracking-widest" style={{ color: 'var(--txt-2)' }}>{t('Network Verified')}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="rounded-2xl border" style={{ background: 'var(--bg-raised)', borderColor: 'var(--border)' }}>
                                ...
                                <section className="space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <p className="text-[10px] mt-1.5 ml-1" style={{ color: 'var(--txt-3)' }}>
                                            {t('Current owner and unassigned dentists are listed.')}
                                        </p>
                            ...
                            <div className="px-8 py-5 border-t flex items-center justify-between" style={{ borderColor: 'var(--border)' }}>
                                ...
                                >
                                    ...
                                    {processing ? t('Saving...') : t('Update Clinic')}
                                </button>
                            </div>
                        </form>
                    </div>
