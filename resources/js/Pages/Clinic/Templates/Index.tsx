        ...
        <ClinicLayout>
            ...
            <div className="flex flex-col gap-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={openCreateModal} className="btn-primary flex items-center gap-2 px-6 py-2.5 rounded-xl shadow-lg shadow-indigo-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {templates.length > 0 ? templates.map((template) => (
                        <div key={template.id} className="card p-6 flex flex-col gap-5 group hover:border-indigo-500/50 transition-all cursor-default" style={{ background: 'var(--bg-raised)' }}>
