...
export default function InvoiceShow({ auth, invoice }: Props) {
 ...
 <button className="btn-primary flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-accent">
 ...
 <Package size={16} className="text-accent" /> {t('Billed Items')}
 </h4>
