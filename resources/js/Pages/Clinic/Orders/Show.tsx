            ...
            <Modal show={!!viewingStl} onClose={() => setViewingStl(null)} maxWidth="2xl">
                <div className="p-5" style={{ background: 'var(--bg-raised)' }}>
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center gap-2">
                            <Box size={16} style={{ color: 'var(--txt-accent)' }} />
                            <h3 className="text-[15px] font-bold" style={{ color: 'var(--txt-1)' }}>{t('3D Model Viewer')}</h3>
                        </div>
                        <button onClick={() => setViewingStl(null)} className="p-1 rounded transition-colors hover:text-red-400" style={{ color: 'var(--txt-3)' }}>
                            <X size={16} />
                        </button>
                    </div>
