                    ...
                    <form onSubmit={handleSearch} className="relative z-10 w-full max-w-xl group mt-2">
                        <div className="relative flex items-center">
                            ...
                            <div className="absolute right-2 top-1/2 -translate-y-1/2">
                                <button type="submit" className="flex items-center justify-center bg-[#818cf8] hover:bg-[#6366f1] text-white px-6 h-10 rounded-xl text-sm font-bold shadow-lg shadow-indigo-500/20 transition-all hover:scale-105 active:scale-95">
                                    {t('Explore')}
                                </button>
                            </div>
                        </div>
