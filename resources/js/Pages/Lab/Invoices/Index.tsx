                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr style={{ borderBottom: '1px solid #312e81', background: 'rgba(15,23,42,0.1)' }}>
                                    <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">{t('Invoice #')}</th>
                                    <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">{t('Clinic')}</th>
                                    <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">{t('Amount')}</th>
                                    <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">{t('Status')}</th>
                                    <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">{t('Due Date')}</th>
                                    <th className="px-6 py-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest text-right">{t('Actions')}</th>
                                </tr>
                            </thead>
                                            ...
                                            <tr key={invoice.id} className="hover:bg-[rgba(15,23,42,0.1)] transition-colors group">
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    <Link
                                                        ...
                                                        className="inline-flex items-center justify-center w-8 h-8 rounded-lg hover:bg-[var(--surface)] transition-all text-slate-400 hover:text-white"
                                                    >
