...
export default function Edit({ service }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        ...
        price: service.price,
        production_days: service.production_days.toString(),
        is_active: service.is_active,
    });

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('lab.services.update', service.id));
    };
        ...
        <LabLayout>
            ...
            <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">Edit Service</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Update details for {service.name}</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-8 space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="border-b border-gray-100 dark:border-slate-700 pb-4 mb-6">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update basic information.</p>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="border-b border-gray-100 dark:border-slate-700 pb-4 mb-6">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update cost and turnaround time.</p>
                        </div>
