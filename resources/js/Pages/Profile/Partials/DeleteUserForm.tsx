    ...
    return (
        <section className={className}>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-8 dark:bg-slate-900 overflow-hidden relative">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative group/field">
                                    <KeyRound className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5 group-focus-within/field:text-rose-500 transition-colors" />
                                    <TextInput
                                        id="password"
                                        type="password"
                                        name="password"
                                        ...
                                        className="pl-12 w-full bg-slate-50 dark:bg-slate-800 border-none rounded-2xl focus:ring-2 focus:ring-rose-500/20 text-slate-700 dark:text-white font-bold h-14"
                                        isFocused
                        ...
                        <div className="mt-10 flex items-center justify-end gap-4">
                            <button
                                type="button"
                                onClick={closeModal}
                                className="text-[10px] font-black text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 uppercase tracking-widest transition-colors flex items-center gap-2 px-6 py-3"
                            >
