    ...
    return (
        ...
        >
            ...
            <div className="w-full h-full flex items-center justify-center p-16">
                ...
                {isStl && (
                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 max-w-lg text-center shadow-2xl">
                        ...
                        <h3 className="text-lg font-black text-slate-900 dark:text-white">{t('3D Model File')}</h3>
                ...
                {!isImage && !isPdf && !isStl && (
                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 max-w-lg text-center shadow-2xl">
                        ...
                        <h3 className="text-lg font-black text-slate-900 dark:text-white">{file.name}</h3>
                        <p className="text-xs text-slate-400 mt-1">{formatSize(file.size)} • {file.type || t('Unknown type')}</p>
                        <a
                            href={fileUrl}
                            download
