                                ...
                                <div className="flex items-center gap-3">
                                    {p.notes && (
                                        <div className="group relative">
                                            ...
                                            <div className="absolute bottom-full right-0 mb-2 w-48 p-3 rounded-xl bg-gray-900 border border-gray-800 shadow-xl text-[11px] text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                                                {p.notes}
                                            </div>
                                        </div>
                                    )}
