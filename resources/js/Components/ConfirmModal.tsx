...
export default function ConfirmModal({
 ...
 {/* Modal */}
 <div className="relative bg-white rounded-2xl shadow-2xl border max-w-md w-full animate-scale-in overflow-hidden">
 {/* Close button */}
 <button
 onClick={onClose}
 className="absolute top-4 right-4 p-1.5 rounded-lg hover: dark:hover: hover: dark:hover: transition-colors"
 >
 <X className="w-4 h-4" />
 </button>
 ...
 onClick={onClose}
 disabled={processing}
 className="flex-1 px-4 py-2.5 rounded-xl border bg-white hover: dark:hover: transition-all text-sm font-medium disabled:opacity-50"
 >
 {cancelText}
 </button>
 <button
