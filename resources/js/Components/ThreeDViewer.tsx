...
function Loader() {
 ...
 <div className="w-8 h-8 rounded-full border-4 border-t-primary-500 animate-spin"></div>
...
class ErrorBoundary extends Component<{ children: ReactNode }, ErrorBoundaryState> {
 ...
 return (
 <div className="flex flex-col items-center justify-center p-6 text-center w-full h-full min-h-[400px] rounded-xl border border-red-500/30">
 ...
 <p className=" text-xs max-w-sm line-clamp-3">
...
export default function ThreeDViewer({ url, color }: ThreeDViewerProps) {
 if (!url) return <div className="p-8 text-center ">Model URL not provided</div>;

 return (
 <ErrorBoundary>
 <div className="w-full h-full min-h-[400px] rounded-xl overflow-hidden shadow-inner relative">
 ...
 <div className="absolute bottom-4 right-4 backdrop-blur-sm px-3 py-1.5 rounded-lg border pointer-events-none">
 <p className="text-[10px] font-medium">Left Click: Rotate &bull; Right Click: Pan &bull; Scroll: Zoom</p>
 </div>
 </div>
 </ErrorBoundary>
 );
